    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Heading — matches reference screenshot */
        .hero-title {
        ...
        <div className="brands-inner">
          ...
          <section className="brands-hero">
            ...
            <div className="search-wrap">
              <div
                ...
                onClick={() => document.getElementById("brands-search")?.focus()}
              >
          ...
          {!loading && !error && (
            <div className="filter-count-row">
              ...
              <span className="results-badge">{total} {total === 1 ? "logo" : "logos"}</span>
            </div>
          )}
          ...
          <div className="brands-grid">
            {loading ? (
              ...
              <div className="state-box">
                {debouncedSearch ? `No logos found for "${debouncedSearch}".` : "No logos found in this category."}
              </div>
            ) : (
